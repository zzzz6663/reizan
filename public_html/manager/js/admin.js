          ...
          $( function() {
            $( "#slider-range" ).slider({
              ...
              slide: function( event, ui ) {
                $( "#amount1" ).val( ui.values[ 0 ] + " هزار ریال"  );
                $( "#amount2" ).val( ui.values[ 1 ] + " هزار ریال"   );
              }
            });
            $( "#amount1" ).val(  $( "#slider-range" ).slider( "values", 0 ) + " هزار ریال"  );
            $( "#amount2" ).val(  $( "#slider-range" ).slider( "values", 1 ) + " هزار ریال"  );
          } );
