@component('admin.section.content',['title'=>'  ویرایش مشتری های ما'])
    @slot('bread')
        <li class="breadcrumb-item"><a href="/admin">پنل مدیریت</a></li>
        <li class="breadcrumb-item">ویرایش مشتری های ما
                        ...
                        <form role="form" action="{{route('customers.update',$customer->id)}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{old('title',$customer->title)}}" class="form-control" id="exampleInputEmail1" placeholder="نام را وارد کنید">
                                </div>
                                <div class="form-group">
                                    ...
                                    <img width="200" height="auto" src="{{asset('/src/customer/'.$customer->image)}}" alt="">
                                </div>
