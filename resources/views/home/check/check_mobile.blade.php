                                ...
                                <div class="row">
                                    <div class="col-lg-6 center-block">
                                        <div>
                                            ...
                                            <div class="boxy">
                                                <form id="fm2" action="{{route('home.check.mobile',$user->id)}}" method="get">
                                                    <h1>
                                                        مرحله دو از چهار
                                                    </h1>
                                                    @csrf
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div>
                                                                <div class="ra">
                                                                    ...
                                                                    <input type="number" name="mobile" readonly value="{{$user->mobile}}" placeholder="لطفا شماره همراه خود را وارد کنید">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <div class="ra">
                                                                    ...
                                                                    <input type="number" name="payam" value="{{old('payam')}}" placeholder="لطفا  کد پیامک شده را وارد کنید">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
