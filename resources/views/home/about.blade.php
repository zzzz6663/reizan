								...
								<span class="icon">
									<svg width="23" height="23" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path fill-rule="evenodd" clip-rule="evenodd" d="M11.9511 14.0534C16.2726 18.3737 17.253 13.3756 20.0045 16.1252C22.6572 18.7772 24.1818 19.3085 20.8209 22.6685C20.3999 23.0068 17.7252 27.0771 8.32507 17.6796C-1.07619 8.281 2.9918 5.60348 3.33022 5.18261C6.69927 1.81333 7.22143 3.34683 9.87411 5.99877C12.6256 8.74954 7.62963 9.73312 11.9511 14.0534Z" fill="currentColor"/>
                                            ...
                                            <span class="after-title">خلاصه ای درباره ریزان</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div>
                                            <div class="top-text">
                                                <p>
                                                    شرکت شاخص توان تیراژه در سال 1380 توسظ جمعی از دانشجویان دانشگاه های برتر کشور بنیان نهاده شد . طی سالیان موفق به دریافت استاندارد ها تاییدیه ها و تقدیر نامه های متعددی از کارفرمایان محترم و سازمان های مختلف شده است .
همچنین موفق شده ایم محصولاتمان را در بسیاری از کشور ها از جمله ارمنستان عراق ترکیه پاکستان و گرجستان عرضه کنیم .
ماندگاری همراه با رشد سریع ریزان الکتریک نشان از کیفیت برتر محصولات می دهد .
با افتخار شما را دعوت به همراهی میکنیم
                                                </p>
                                            </div>
